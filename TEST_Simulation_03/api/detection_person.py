...
class Api:
    ...
    def save_yolo_label(list_cordinate, filenames):
        ...
        for cordinate in list_cordinate:
            yolo_coord = Api.polygon2yolo(cordinate[0],cordinate[1],cordinate[2],cordinate[3]) #욜로 변환
            ...
            if people:
                ...
                if cv2.waitKey(1) & 0xFF == ord('q'):
                    print("원래는 continue")
                     ...
                     client.simClearDetectionMeshNames(self.camera_name, self.image_type)
                elif cv2.waitKey(1) & 0xFF == ord('a'):
                    client.simAddDetectionFilterMeshName(self.camera_name, self.image_type, self.object_0)
                    client.simAddDetectionFilterMeshName(self.camera_name, self.image_type, self.object_1)
