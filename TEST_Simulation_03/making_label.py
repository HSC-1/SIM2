...
class Preprocessing:
    ...
    def __init__(self,path=None,list_files_name = None,png_dir_path =None):
        #리눅스 코드 os.chdir("../")
        #리눅스 코드 self.path =os.getcwd()
        # vs 환경 vscode환경이랑 차이가 있는듯 
        self.path = os.getcwd()
        # self.path = os.path.dirname(os.getcwd())
        

        #리눅스 코드 self.png_dir_path =self.path+ "Preprocessing-main/sample/gtFine/train/train/"
        self.png_dir_path =self.path+ "\\Preprocessing-main\\sample\\gtFine\\train\\train\\"
    ...
    def kor_make_label(self):
        ...
        # 리눅스코드 png_dir_path = self.path + "/Preprocessing-main/sample/gtFine/train/train/"
        # 리눅스코드 save_dir_building_path = self.path + "/Preprocessing-main/sample/make_label/kor_buildings/"
        # 리눅스코드 save_dir_road_path = self.path + "/Preprocessing-main/sample/make_label/kor_roads/"
        # 리눅스코드 save_dir_multi_path = self.path + "/Preprocessing-main/sample/make_label/kor_multi/"
        
        png_dir_path = self.path + "\\Preprocessing-main\\sample\\gtFine\\train\\train\\"
        ...
        for filename in self.list_files_name :
            ...
            #리눅스 코드 path값 : /home/aiffel/0.KD_hackathon/Preprocessing-main/sample/gtFine/train/train/LC_AP_37607046_004_1024.png
