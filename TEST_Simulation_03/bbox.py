...
class yolo2voc:
    ...
    def __init__(self):
        ...
        self.path = os.path.os.getcwd()
        print("yolo2voc_기론경로{}".format(self.path))

        self.label_dict = {}

        # #json 폴더 경로
        # self.path_txt_dir = "/home/aiffel-dj16/sim2data/pythonQT/bbox/label"
        # print("txt 폴더경로 : {}".format(self.path_txt_dir))

        # #read json folder
        # list_file = os.listdir(self.path_txt_dir)
        # self.list_file_name = [ file for file in list_file if file.endswith(".txt")]
        # self.list_file_name.sort() # 정렬
        # print("txt파일명 리스트출력 : {}".format(self.list_file_name))


    def yolo2coco(self, image_dir_path, label_dir_path, save_file_name, is_normalized):
